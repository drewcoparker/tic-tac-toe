...
$(document).ready(function() {
    ...
    // Computer functions
    // Computer checks to see if a winning square is available
    function goForWin(){
        var winningMove;
    ...
    //If no winning square is available, computer checks to see if it can block
    //player1's victory
    function blockMove() {
        var blockingMove;
        for (let i = 0; i < winningCombos.length; i++) {
    ...
    //Computer's main function to determine what square to pick.
    ...
    //Check for a winner. Gets called after every turn.
    ...
    //Reset the game when someone won or tied.
    function reset() {
